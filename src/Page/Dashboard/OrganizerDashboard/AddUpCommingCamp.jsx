...
const AddUpComingCamp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (res.data.success) {
      ...
      const campRes = await secureApi.post("/add-upComing-Camp", campData);
      if (campRes.data.insertedId) {
        Swal.fire({
          position: "center ",
          icon: "success",
          title: `${data.name} added to UpComing camp successfully`,
  ...
  return (
    <div>
      <div className="bg-base-200 p-10">
        <h2 className="text-3xl text-center my-5 font-bold">Up coming Camp</h2>
